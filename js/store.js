...
const Store = (() => {
  ...
  return {
    ...
    applyRemote(id, {name, color, uids, mem: ranges, rev, mis, up, goal, nl, prog, wird, lis, wkp, hifz}){
      ...
      const d = data(id);
      if ((up || 0) > (d.up || 0)){ Object.assign(d, {mem: ranges, rev: rev || {}, mis: mis || {}, up, goal: goal || null, nl: nl || {}, prog: prog || null, wird: wird || null, lis: lis || {}, wkp: wkp || {}, hifz: hifz || null}); delete memCache[id]; }
      save();
    },
